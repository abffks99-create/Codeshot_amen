...
"""
        ...
        try:
            ...
            if '고위험' in ai_result: critical_level = '고위험'
            elif '중위험' in ai_result: critical_level = '중위험'
            elif '저위험' in ai_result: critical_level = '저위험'
            else: critical_level = '안전'
            # 블랙리스트 직접 탐지된 경우 최소 고위험
            if is_blacklisted and critical_level not in ('고위험',):
                critical_level = '고위험'
        except Exception as e:
